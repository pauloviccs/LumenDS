...
export default function PlayerView({ playlist }) {
    ...
    if (src && (src.includes(':\\') || src.startsWith('/'))) {
        // Extract filename
        // Split by \ for Windows, / for others. 
        const filename = src.split(/[/\\]/).pop();
        // Point to Local Asset Server
    ...
    return (
        <div className="bg-black w-full h-screen overflow-hidden relative">
            ...
            <div className="absolute top-2 left-2 bg-black/50 text-white text-[10px] p-1 rounded opacity-0 hover:opacity-100 transition-opacity">
